...
func TestRunJoinShortAlias(t *testing.T) {
	...
	mtesting.AssertNoError(t, err)
	mtesting.AssertEqual(t, resolvedAlias, "#construct-board:localhost")
	mtesting.AssertEqual(t, joinedRoom, "!board:localhost")
}
...
func TestRunJoinFullAlias(t *testing.T) {
	...
	mtesting.AssertNoError(t, err)
	mtesting.AssertEqual(t, resolvedAlias, "#general:example.com")
}
