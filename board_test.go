...
func TestRunBoardPostSuccess(t *testing.T) {
	...
	mtesting.AssertEqual(t, sentRoom, "!board:localhost")
	mtesting.AssertEqual(t, sentMsg, "hello board")
}
...
func TestRunBoardPostCreatesRoom(t *testing.T) {
	...
	mtesting.AssertNoError(t, err)
	mtesting.AssertEqual(t, created, true)
}
...
func TestRunBoardWatchSuccess(t *testing.T) {
	...
	mtesting.AssertNoError(t, err)
	mtesting.AssertEqual(t, callCount, 2)
}
...
func TestRunBoardWatchFollow(t *testing.T) {
	...
	mtesting.AssertError(t, err)
	mtesting.AssertEqual(t, callCount, 4)
}
